...
protected:
  NativeRNSentryCxxSpec(std::shared_ptr<CallInvoker> jsInvoker) : TurboModule(std::string{NativeRNSentryCxxSpec::kModuleName}, jsInvoker) {
    ...
    methodMap_["removeContext"] = MethodMetadata {.argCount = 1, .invoker = __removeContext};
    ...
    methodMap_["addFeatureFlag"] = MethodMetadata {.argCount = 2, .invoker = __addFeatureFlag};
    ...
    methodMap_["pauseAppHangTracking"] = MethodMetadata {.argCount = 0, .invoker = __pauseAppHangTracking};
    methodMap_["resumeAppHangTracking"] = MethodMetadata {.argCount = 0, .invoker = __resumeAppHangTracking};
  }
...
private:
  ...
  static jsi::Value __removeContext(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
    static_assert(
      bridging::getParameterCount(&T::removeContext) == 2,
      "Expected removeContext(...) to have 2 parameters");
    bridging::callFromJs<void>(rt, &T::removeContext,  static_cast<NativeRNSentryCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule),
      count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asString(rt));return jsi::Value::undefined();
  }
  ...
  static jsi::Value __addFeatureFlag(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
    static_assert(
      bridging::getParameterCount(&T::addFeatureFlag) == 3,
      "Expected addFeatureFlag(...) to have 3 parameters");
    bridging::callFromJs<void>(rt, &T::addFeatureFlag,  static_cast<NativeRNSentryCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule),
      count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asString(rt),
  ...
  static jsi::Value __pauseAppHangTracking(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* /*args*/, size_t /*count*/) {
    static_assert(
      bridging::getParameterCount(&T::pauseAppHangTracking) == 1,
      "Expected pauseAppHangTracking(...) to have 1 parameters");
    bridging::callFromJs<void>(rt, &T::pauseAppHangTracking,  static_cast<NativeRNSentryCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule));return jsi::Value::undefined();
  }

  static jsi::Value __resumeAppHangTracking(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* /*args*/, size_t /*count*/) {
    static_assert(
      bridging::getParameterCount(&T::resumeAppHangTracking) == 1,
      "Expected resumeAppHangTracking(...) to have 1 parameters");
    bridging::callFromJs<void>(rt, &T::resumeAppHangTracking,  static_cast<NativeRNSentryCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule));return jsi::Value::undefined();
  }
};
