...
with_node \
  ...
  --target "/Users/andrewg/Projects/zephyr-weather/ios/Pods/Target Support Files/Pods-ZephyrWeather/ExpoModulesProvider.swift" \
  --target-name "ZephyrWeather" \
  --entitlement "/Users/andrewg/Projects/zephyr-weather/ios/ZephyrWeather/ZephyrWeather.entitlements" \
   \
  --podfile-properties-file-path "/Users/andrewg/Projects/zephyr-weather/ios/Podfile.properties.json" \
  --platform "apple" \
